...
class ContactPage1124(BasePage1124):
    ...
    def deletemember(self, username1, username2):
        deletename_checkbox1 = (By.XPATH, f"//*[@title='{username1}']/..//*[@type='checkbox']")
        deletename_checkbox2 = (By.XPATH, f"//*[@title='{username2}']/..//*[@type='checkbox']")
        eles = self.finds(self._member_list)
