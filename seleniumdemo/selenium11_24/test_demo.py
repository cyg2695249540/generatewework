...
class TestDemo:
    ...
    def test_delete_member(self, username1, username2, result):
        ...
        if username1 and username2 not in namelist:
            ...
            self.driver.find_element(By.XPATH, f"//*[@title='{username1}']/..//*[@type='checkbox']").click()
            self.driver.find_element(By.XPATH, f"//*[@title='{username2}']/..//*[@type='checkbox']").click()
