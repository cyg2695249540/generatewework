...
class TestDemo:
    ...
    def test_send_message(self):
        ...
        if len(eles) < 2:
            ...
            eles[-1].click()
        self.driver.find_element(MobileBy.ID, "com.tencent.wework:id/eo7").send_keys("test11.26")
    ...
    @pytest.mark.parametrize("name, gander, phone", [("CYFF", "男", 13711111111)], ids={"addmember"})
    def test_addmember(self, name, gander, phone):
        ...
        if gander == "女":
            ...
            element.click()
        self.driver.find_element(MobileBy.XPATH, "//*[@text='手机号']").send_keys(str(phone))
        self.driver.find_element(MobileBy.XPATH, "//*[@text='保存']").click()
        mytoast = self.driver.find_element(MobileBy.XPATH, "//*[@class='android.widget.Toast']").text
        assert mytoast == "添加成功"

    @pytest.mark.parametrize("name", [("CYFF")], ids={"delete member"})
